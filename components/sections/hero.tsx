              ...
              <div className="border-t border-edge">
                <div className="px-4 py-4">
                  ...
                  <div className="text-sm text-zinc-400 leading-relaxed space-y-4">
                    ...
                    <h3 className="text-lg font-poppins font-semibold mb-3 text-zinc-300 flex items-center gap-2">
                      experience
                    </h3>
                    <p className="font-poppins">
                        arysoft global services -full stack software developer
                    </p>
                    <p className="font-poppins"> mealmeal - freelance frontend developer</p>
                  </div>
                </div>
              </div>
            </div>
